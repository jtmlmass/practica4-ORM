                ...
                <div class="row align-content-start">
                    <#if usuario != "">
                        <div class="col btn-group btn-group-toggle" data-toggle="buttons">
                            <span class="btn btn-outline-info" name="like"><a class="text-gray-dark" href="/postReaccion/${articulo.id}">Like</a></span>
                            <span class="btn btn-outline-danger" name="dislike"><a class="text-gray-dark" href="/postReaccion/${articulo.id}">Disike</a></span>
                        </div>
                        <#if isAdmin || articulo.autor.username == usuario.username>
                            <div class="col">
